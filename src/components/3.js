...
export class ThirdStep extends React.Component {
  ...
  componentDidMount() {
    if(this.tokenStore.dublicates.length > 0){
      ...
      swal({
        ...
        text: `${JSON.stringify(this.tokenStore.dublicates.slice(), null, '\n')}.\n Coindrop already combined the balances for those addreses. Please make sure it did the calculation correctly.`,
        icon: "warning",
      })
    }
  }
  onNext(e) {
    ...
    //   swal({
    //     title: "Insufficient OKT balance",
    //     text: `You don't have enough OKT to send to all addresses. Amount needed: ${this.tokenStore.totalCostInEth} OKT`,
    //     icon: "error",
    //   })
    //   return
    // }
    ...
    return (
      <div className="container container_bg">
        <div className="content">
          ...
          This Dapp supports OkexTestChain
          </p>
          <form className="form">
            ...
            <div className="send-info">
              <div className="send-info-side">
                ...
                {/* <div className="send-info-i">
                  ...
                  <p className="send-info-amount">{this.tokenStore.currentFee} OKT </p>
                </div> */}
                <div className="send-info-i">
                  <p>Your OKT Balance</p>
              ...
              <div className="send-info-side">
                ...
                <div className="send-info-i">
                  ...
                  {this.tokenStore.totalCostInEth} OKT        
                  </p>
                </div>
                <div className="send-info-i">
