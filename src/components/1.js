...
export class FirstStep extends React.Component {
  ...
  async onSubmit(e){
    ...
    if(this.tokenStore.invalid_addresses.length > 0){
      swal({
        title: "There are invalid eth addresses. If you click Next, coindrop will remove them from the list.",
      ...
      <div className="container container_bg">
        ...
        <div className="content">
          ...
          <p className="description">
            ...
            This Dapp supports OkexTestChain <br/>
          ...
          <Form className="form">
            ...
            { this.parseCompleted ? 'One moment ...' : 'NEXT' }
            </Button>
          </Form>
        </div>
      </div>
